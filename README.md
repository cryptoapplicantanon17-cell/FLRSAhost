...
> [!WARNING]
> Ensure your card reader is connected. Adjust the `-key` parameter if your card uses non-default transport keys. Please ensure the ISD and the AID match your card; otherwise, you may need to modify them.
